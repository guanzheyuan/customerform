...
import { Row, Col, Card, Form, Input, Icon, Button, Dropdown, Menu, message, Divider } from 'antd';
...
@Form.create()
class QuotaTargetProcessManage extends PureComponent {
  state = {
    expandForm: false,
    selectedRows: [],
    formValues: {},
  ...
  handleModalVisible = () => {
    ...
    router.push('/Economy/LotEditQuotaTargetProcess', yearData);
  };
  ...
  handleEditModalVisible = (flag, record) => {
    const pageState = 1;
    router.push({
      pathname: '/Economy/EditQuotaTargetProcess',
      record,
      pageState,
    });
  };
    ...
    return (
      <Form onSubmit={this.handleSearch} layout="inline">
        <Row gutter={{ md: 8, lg: 24, xl: 48 }}>
          ...
          <Col span={6}>
            <FormItem label="年份">
              {getFieldDecorator('yearDate', { initialValue: year })(
  ...
  render() {
    ...
    return (
      <PageHeaderWrapper title="指标目标进度管理">
        <Card bordered={false}>
...
export default QuotaTargetProcessManage;
